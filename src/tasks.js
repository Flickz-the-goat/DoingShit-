...
export function tasks(){
    for(let i = 0; i < tlist.length; i++){
        ...
        taskName.textContent = tlist[i].taskName;
        taskDescription.textContent = tlist[i].taskDescription;
        priority.textContent = tlist[i].priority; 
        type.textContent = tlist[i].type;
        dueDate.textContent = tlist[i].dueDate; 
